...
"[project]/lib/lca/schema.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/lca/validate.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$lca$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/lca/schema.ts [app-route] (ecmascript)");
;
function validateField(field, raw, context = {}) {
    ...
    if (field.kind === "categorical") {
        const options = field.dependsOn === "metal" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$lca$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRoutesForMetal"])(context.metal) : field.options ?? [];
...
function validateAll(values) {
    ...
    for (const key of Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$lca$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FIELDS_BY_KEY"])){
        const field = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$lca$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FIELDS_BY_KEY"][key];
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$lca$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/lca/validate.ts [app-route] (ecmascript)");
;
;
const HF_ENDPOINT = "https://khushal-grover2005-lca-predictor.hf.space/predict";
async function POST(request) {
    ...
    const { errors, payload, isValid } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$lca$2f$validate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateAll"])(normalized);
    if (!isValid) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: "error",
    ...
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: "error",
            message: err instanceof Error ? err.message : "Failed to reach predictor service."
        }, {
            status: 502
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6696bd53._.js.map